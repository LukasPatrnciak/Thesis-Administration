...
public abstract class AbstractThesisService<S, T, A> implements AutoCloseable {
     ...
     * @param password Heslo pre účet študenta
     ...
     * @param password   Heslo pre účet pedagóga.
     ...
     */
    public abstract A makeThesisAssignment(Long supervisor, String registrationNumber, String title, String type, String description);
     ...
     *
     * @param thesisId Identifikátor inštancie entity záverečnej práce.
     * @param studentId Identifikátor študenta priradeného k práci.
     * @return Aktualizovanú inštanciu entity záverečnej práce. V prípade chyby vráti null.
     ...
     */
    public abstract A submitThesis(Long thesisId, Long studentId);
