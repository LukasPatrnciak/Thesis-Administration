...
public interface PageableThesisService<S, T, A> {
     ...
     * Ak nie je nájdená žiadna entita je vrátená prázdna strana.
     */
    Page<A> findTheses(Optional<Long> studentId, Optional<Long> teacherId, Optional<String> department, Optional<Date> publishedOn, Optional<String> type, Optional<String> status, Pageable pageable);
